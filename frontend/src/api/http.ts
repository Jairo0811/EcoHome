...
export const api={
  ...
  getResourceSummary:(range:'day'|'week'|'month'='day')=>request<ResourceSummary>(`/resources/summary/?range=${range}`),
  getResourceHistory:(metric:ResourceMetric,days=30)=>request<ResourceHistory>(`/resources/history/?metric=${metric}&days=${days}`),
};
