...
INSTALLED_APPS = [
    ...
    "rest_framework", "apps.core", "apps.accounts", "apps.homes", "apps.devices", "apps.iot", "apps.resources", "apps.automation", "apps.dashboard",
]
MIDDLEWARE = [
...
WSGI_APPLICATION = "ecohome.wsgi.application"
ASGI_APPLICATION = "ecohome.asgi.application"
if os.getenv("POSTGRES_HOST"):
    DATABASES = {"default": {"ENGINE": "django.db.backends.postgresql", "NAME": os.getenv("POSTGRES_DB", "ecohome"), "USER": os.getenv("POSTGRES_USER", "ecohome"), "PASSWORD": os.getenv("POSTGRES_PASSWORD", ""), "HOST": os.getenv("POSTGRES_HOST", "localhost"), "PORT": os.getenv("POSTGRES_PORT", "5432"), "CONN_MAX_AGE": 60}}
else:
